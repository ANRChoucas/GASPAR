...
<p class="titlestep">Étape 2 <i>(suite)</i></p> \
<p class="importantstep">
- ou bien en saisissant l'indice en langage naturel dans le bloc-note prévu à cet effet puis en ouvrant un menu contextuel \
...
`,
  ...
  tour.onafterchange(() => {
    switch (tour._currentStep) {
      ...
      case 9:
        {
          ...
          map_view.setCenter([672056.66, 5630226.11]);
          map_view.setZoom(13.9);
          setTimeout(() => {
      ...
      case 12:
        setTimeout(() => {
          document.getElementById('hydrologie').click();
        }, 800);
        break;
      case 14:
        {
          const coords_clicked = toLonLat([672056.66, 5630684.73])
