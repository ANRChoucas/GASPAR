...
export default function createMenuBar() {
  ...
  menu1.addItem({ command: 'app:new' });
  menu1.addItem({ command: 'app:load' });
  menu1.addItem({ command: 'app:save' });
  menu1.addItem({ command: 'app:export' });
  // menu1.addItem({ command: 'app:print' });
  menu1.addItem({ command: 'app:close' });
  ...
  // menu2.addItem({ command: 'tools:zlp_widget' });
